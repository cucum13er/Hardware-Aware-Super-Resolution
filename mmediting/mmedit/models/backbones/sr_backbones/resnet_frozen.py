...
class ResNet(BaseModule):
    ...
    def __init__(self,
                 ...
                 init_cfg=dict(type='Pretrained', checkpoint='work_dirs/selfsup/simclr/simclr_resnet18_epoch2000_temp0_05_DIV2K/weights_2000.pth')):####################add checkpoint##############
    ...
    def forward(self, x):
        ...
        for i, layer_name in enumerate(self.res_layers):
            ...
            x = res_layer(x)
            # breakpoint()
            # print(res_layer[1].conv2.weight)
            if i + 1 in self.out_indices:
                outs.append(x)
                # print(res_layer[1].conv2.weight.grad)
