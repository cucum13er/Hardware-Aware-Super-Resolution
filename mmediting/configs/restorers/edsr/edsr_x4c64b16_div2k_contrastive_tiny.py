...
data = dict(
    ...
    val=dict(
        ...
        lq_folders=   [
                    #'data/MultiDegrade/DIV2K/X4/val/sig_0.5',
                    #'data/MultiDegrade/DIV2K/X4/val/sig_01',
                    # 'data/MultiDegrade/DIV2K/X4/val',
    ...
    test=dict(
        type=val_dataset_type,
        lq_folders= [
                    #'data/MultiDegrade/DIV2K/X4/test/sig_0.5',
                    ...
                    # 'data/MultiDegrade/DIV2K_tiny/X4/train',   
...
# learning policy
total_iters = 4000#####
lr_config = dict(policy='Step', by_epoch=False,step=[1000, 2000, 3000, 4000], gamma=0.5)
