exp_name = 'haedsr_contrastive_DRealSR'
...
model = dict(
        ...
        contrastive_loss_factor = 0.0000001,
        )
...
load_from = None #'work_dirs/restorers/haedsr/edsr_x4c64b16_div2k_contrastive/iter_20000_cont_pretrain.pth'
resume_from = None
workflow = [('train', 1)]
