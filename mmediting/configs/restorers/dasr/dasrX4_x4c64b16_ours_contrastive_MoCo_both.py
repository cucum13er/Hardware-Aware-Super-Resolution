...
model = dict(
        ...
        contrastive_part = dict(
                    ...
                    backbone=dict(
                        type='EasyRes',
                        in_channels=3,
                        pretrained = '/home/rui/Rui_SR/mmselfsup/work_dirs/selfsup/moco/X4_moco_easyres_Ours_supcon_S1/weights_1000.pth',
                        ),
                    neck=dict(
                        type='MoCoV2Neck',
                        in_channels=512,
...
load_from = './work_dirs/restorers/dasr/dasr_x4c64b16_div2kflickr2k_contrastive_MoCo_both_6-layer-pretrain/iter_200000.pth'
