...
model = dict(
        ...
        contrastive_part = dict(
                    ...
                    backbone=dict(
                        type='EasyRes',
                        in_channels=3,
                        pretrained = '/home/rui/Rui_SR/mmselfsup/work_dirs/selfsup/moco/moco_easyres_DRealSR/weights_2000.pth',
                        ),
                    neck=dict(
                        type='MoCoV2Neck',
                        in_channels=512,
...
data = dict(
    ...
    train=dict(
        ...
        dataset=dict(
            ...
            gt_folder='/media/rui/Rui_T7/DRealSR/Train_x4/train_LR',
    ...
    #     gt_folder= '/media/rui/Rui_T7/DRealSR/Test_x4/test_LR',
