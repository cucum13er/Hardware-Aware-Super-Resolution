...
model = dict(
        ...
        contrastive_part = dict(
                    ...
                    backbone=dict(
                        type='EasyRes',
                        in_channels=3,
                        pretrained = None#'/home/rui/Rui_SR/mmselfsup/work_dirs/selfsup/moco/moco_easyres_realMicron_cls3/weights_1000.pth',
                        ),
                    neck=dict(
                        type='MoCoV2Neck',
                        in_channels=512,
...
data = dict(
    ...
    train=dict(
        ...
        dataset=dict(
            ...
            gt_folder='data/Ours_noNew/X2_train',
...
resume_from = 'work_dirs/restorers/hasr/X2/hasr_real-micron_from_None/iter_80000.pth'
workflow = [('train', 1)]
