...
model = dict(
        ...
        contrastive_part = dict(
			...
			init_cfg=None,
			#init_cfg=dict(type='Pretrained', checkpoint='/home/rui/Rui_SR/mmselfsup/work_dirs/selfsup/moco/moco_resnet18_epoch2000_temp0_07_DIV2K_supcon/weights_2000.pth'),			
			),
                    neck=dict(
                        type='MoCoV2Neck',
                        in_channels=512,
...
data = dict(
    workers_per_gpu=8,
    train_dataloader=dict(samples_per_gpu=64, drop_last=True),
...
load_from = None #'work_dirs/restorers/dasr/dasr_x4c64b16_div2kflickr2k_contrastive_MoCo/iter_30000.pth'
resume_from = None
workflow = [('train', 1)]
