...
#     """random size cropping augmentation refers to `SimCLR.
#     <https://arxiv.org/abs/2002.05709>`_.

#     Args:
#         sigma_min (float): The minimum parameter of the patch size.
#         sigma_max (float): The maximum parameter of the patch size.
       
#     """

#     def __init__(self, size_min, size_max):
#         assert size_min <= size_max \
#             f'The minimum size should be smaller than the maximum size but got max at {size_max} instead.'
...
#     def __repr__(self):
#         repr_str = self.__class__.__name__
#         repr_str += f'size_min = {self.size_min}, '
#         repr_str += f'size_max = {self.size_max}, '
#         return repr_str
