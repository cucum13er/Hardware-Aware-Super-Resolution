...
WORK_DIR=$3 # work folder###########################
PY_ARGS=${@:4} ######################
GPUS=${GPUS:-1}  # When changing GPUS, please also change imgs_per_gpu in the config file accordingly to ensure the total batch size is 256.
PORT=${PORT:-29500}
