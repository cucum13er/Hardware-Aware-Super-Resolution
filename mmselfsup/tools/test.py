...
from mmselfsup.utils import get_root_logger, multi_gpu_test, single_gpu_test, multi_gpu_test_Rui
...
def main():
    ...
    if not distributed:
        ...
        outputs = multi_gpu_test_Rui(model, data_loader)  
################################################################################
    rank, _ = get_dist_info()
    if rank == 0:
        dataset.evaluate(outputs, logger, save_path=cfg.work_dir)#######################
